...
export class FirebaseService {
    ...
    private _categoriesColl: string = "categories";
    private _userColl: string = "users";
    private _imagesColl: string = "images";
    ...
    getCollectionURL(coll){
        let localCenter = localStorage.getItem('center') ? localStorage.getItem('center') : this._categoriesColl;
        return this._imagesColl + "/" + localCenter + "/" + coll;
    /**
        let _collURL = "";
